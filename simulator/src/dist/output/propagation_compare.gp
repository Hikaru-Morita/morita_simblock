...
plot "~/Desktop/propagation_compare.dat" with boxes linewidth 2 lc rgb "gray" notitle \
, 7.49 with line linecolor 'red' linewidth 2 title "proposal method" \
, 7.94 with line linecolor 'blue' linewidth 2 title "Default"
