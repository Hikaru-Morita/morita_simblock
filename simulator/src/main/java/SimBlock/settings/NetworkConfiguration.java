...
public class NetworkConfiguration {
	...
	private static long[] DOWNLOAD_BANDWIDTH_2019_3times = {52000000, 40000000, 18000000, 62800000, 62800000, 69900000, 6 * 1000000};
	
	public static void change_dl_bw_2015(long[] num){
		DOWNLOAD_BANDWIDTH = num;
	} 

	public static long[] DOWNLOAD_BANDWIDTH = DOWNLOAD_BANDWIDTH_2019_3times;
	...
	private static final long[] UPLOAD_BANDWIDTH_2019_3times =  { 19200000,  20700000, 5800000,  30700000,  20200000,  21300000, 6 * 1000000};

	public static final long[] UPLOAD_BANDWIDTH = UPLOAD_BANDWIDTH_2019_3times;
